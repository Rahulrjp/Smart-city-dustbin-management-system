const SettingsOption = ({ icon: Icon, label, sub, onclick }) => (
    <button className="flex items-start gap-4 p-4 rounded-2xl hover:bg-slate-800 transition-colors text-left w-full group" onClick={onclick}>
